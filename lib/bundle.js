...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__background__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__runner__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__obstacle__ = __webpack_require__(6);
...
class Game {
  constructor(gameCanvas, gameCtx, backgroundCtx) {
    ...
    this.runner = new __WEBPACK_IMPORTED_MODULE_2__runner__["a" /* default */](gameCtx);
    this.createBackground(backgroundCtx, 3);
    this.bindKeyHandlers();

    this.menu = new __WEBPACK_IMPORTED_MODULE_0__menu__["a" /* default */](this);
  ...
  createBackground(ctx, speed) {
    ...
    bg.onload = () => {
      this.background = new __WEBPACK_IMPORTED_MODULE_1__background__["a" /* default */](ctx, bg, speed);
    };
  }
  ...
  draw() {
    if (!this.gameOver) {
      ...
      if (!this.pause) {
        ...
        this.gameCtx.font = 'bold 20px Courier';
        this.gameCtx.fillStyle = 'white';
        this.gameCtx.textAlign = 'left';
        this.gameCtx.fillText(`Score: ${this.score}`, 900 - 140, 30);
  ...
  randomSpawnInterval() {
    const intervals = [500, 1500, 3000, 4500];
  ...
  spawnObstacles() {
    ...
    if (Math.random() > 0.50 && this.obstacles.length < 5) {
      this.obstacles.push(new __WEBPACK_IMPORTED_MODULE_3__obstacle__["a" /* default */](
        this.gameCtx,
        IMGS[idx][0],
        IMGS[idx][1],
        8,
  ...
  start() {
    document.getElementsByClassName('game-canvas')[0].focus();
    this.obstacles = [];
    this.pause = false;
    this.gameOver = false;
    this.ticker = 0;
...
class Menu {
  ...
  setMenuButtonListeners() {
    ...
    this.playButton.addEventListener('click', e => {
      this.closeMainMenu();
      setTimeout(() => this.game.start(), 200);
    });
  }
