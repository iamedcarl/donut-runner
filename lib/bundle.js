...
class Game {
  ...
  createObstacles(ctx) {
    this.obstacleSelma = new __WEBPACK_IMPORTED_MODULE_2__obstacle__["a" /* default */](ctx, OBSTACLES[0][0], OBSTACLES[0][1]);
    this.obstacleBarney = new __WEBPACK_IMPORTED_MODULE_2__obstacle__["a" /* default */](ctx, OBSTACLES[1][0], OBSTACLES[1][1]);
    this.obstacleMartin = new __WEBPACK_IMPORTED_MODULE_2__obstacle__["a" /* default */](ctx, OBSTACLES[2][0], OBSTACLES[2][1]);
    this.obstacleMilhouse = new __WEBPACK_IMPORTED_MODULE_2__obstacle__["a" /* default */](ctx, OBSTACLES[3][0], OBSTACLES[3][1]);
    this.obstacleBaby = new __WEBPACK_IMPORTED_MODULE_2__obstacle__["a" /* default */](ctx, OBSTACLES[4][0], OBSTACLES[4][1]);
  }
